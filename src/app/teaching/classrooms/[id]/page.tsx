...
const mockClassroom = {
  ...
  joinLink: '/join/MATHX10ADV', // This link might need re-evaluation in a real app
  students: [
    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button variant="outline" asChild>
            <Link href={`/teaching/classrooms/${classroom.id}/edit`}><Settings className="mr-2 h-4 w-4" />Configuración</Link>
        </Button>
        ...
        <TabsContent value="content">
          <Card className="shadow-md">
            <CardHeader className="flex flex-row justify-between items-center">
              ...
              <Button asChild><Link href={`/teaching/content?classroom=${classroom.id}`}><UploadCloud className="mr-2 h-4 w-4" />Subir Contenido</Link></Button>
            </CardHeader>
            <CardContent>
              {classroom.content.length > 0 ? (
                ...
                <div className="text-center py-8">
                    ...
                    <Button className="mt-4" asChild><Link href={`/teaching/content?classroom=${classroom.id}`}><PlusCircle className="mr-2 h-4 w-4" /> Agregar Primer Material</Link></Button>
                </div>
              )}
            </CardContent>
          </Card>
