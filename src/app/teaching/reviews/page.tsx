  ...
  return (
    <div className="space-y-8 pt-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card className="shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Valoración Media (Profesor)</CardTitle>
        ...
        <Card className="shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Total de Reseñas Recibidas</CardTitle>
      ...
      <Card className="shadow-xl">
        <CardHeader>
          <CardTitle className="font-headline text-2xl">Reseñas Detalladas de tus Cursos</CardTitle>
          <CardDescription>Lee lo que dicen tus estudiantes sobre tus cursos y enseñanza.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {mockReviews.length > 0 ? (
            ...
            <p className="text-muted-foreground text-center py-8">Aún no se han recibido reseñas para tus cursos.</p>
          )}
        </CardContent>
      </Card>
    </div>
