...
import { CalendarDays, PlusCircle, Clock, Video, Edit } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageTitle title="Horario de Enseñanza" description="Gestiona los horarios de tus clases, talleres y horas de consulta." className="mb-0" />
      ...
      <Card className="shadow-lg">
          <CardHeader>
              <CardTitle className="font-headline text-xl">Vista General del Calendario (Profesor)</CardTitle>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="font-headline text-2xl flex items-center"><CalendarDays className="mr-2 text-primary" />Próximos Eventos de Enseñanza</CardTitle>
          <CardDescription>Tus clases y sesiones programadas como profesor.</CardDescription>
        </CardHeader>
        <CardContent>
          {teacherSchedule.length > 0 ? (
            ...
            <p className="text-muted-foreground text-center py-6">No tienes próximos eventos programados. <Link href="/teaching/schedule/new" className="text-primary hover:underline">¡Programa uno ahora!</Link></p>
          )}
        </CardContent>
      </Card>
    </div>
