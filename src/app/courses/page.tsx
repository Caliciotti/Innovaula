...
const mockFeaturedCourses = mockCourses.slice(0, 3); 
...
const mockCategories = [
  ...
  { name: 'Negocios', icon: BriefcaseIcon, dataAiHint: 'edificio negocios', courseCount: 30, image: 'https://placehold.co/300x200.png' },
  { name: 'Artes y Humanidades', icon: PaletteIcon, dataAiHint: 'pincel arte', courseCount: 12, image: 'https://placehold.co/300x200.png' },
];


export default function CourseDiscoveryPage() {
  return (
    <div className="space-y-12 pt-4"> {/* Added pt-4 for spacing if PageTitle was providing it */}
      ...
      <section className="space-y-6">
         <div className="flex justify-between items-center">
            ...
            {/* <Button variant="link" className="text-primary">Ver todos</Button> // Podr\u00eda ser un paginador o scroll infinito */}
         </div>
...
function CategoryCard({ category }: CategoryCardProps) {
  ...
  return (
    <Link href={`/courses?category=${encodeURIComponent(category.name)}`} className="block group">
