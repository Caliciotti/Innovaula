...
const mockContent = [
  { id: 'cnt1', name: 'Fundamentos de Álgebra.pdf', type: 'Documento', course: 'Matemáticas 9º Grado', size: '2.5MB', lastUpdated: '2024-07-20', status: 'Publicado' },
  { id: 'cnt2', name: 'Serie de Clases de Cálculo - Parte 1.mp4', type: 'Video', course: '10º Grado - Matemáticas Avanzadas', size: '150MB', lastUpdated: '2024-07-18', status: 'Publicado' },
  { id: 'cnt3', name: 'Simulación Interactiva de Física: Fuerzas', type: 'Módulo', course: 'AP Física C: Mecánica', size: 'N/A', lastUpdated: '2024-07-15', status: 'Borrador' },
  { id: 'cnt4', name: 'Guía de Análisis de Poesía.docx', type: 'Documento', course: 'Taller de Escritura Creativa - Otoño 2024', size: '800KB', lastUpdated: '2024-07-10', status: 'Publicado' },
];
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageTitle title="Biblioteca de Contenido" description="Gestiona todos tus materiales de enseñanza en un solo lugar." className="mb-0" />
        ...
        <CardHeader>
            <div className="flex flex-col md:flex-row gap-4 justify-between">
                <div className="relative flex-grow max-w-md">
                  ...
                  <Input type="search" placeholder="Buscar contenido por nombre o curso..." className="pl-10" />
                </div>
